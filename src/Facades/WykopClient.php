 ...
 * @method static array getSearchAll(string $query, ?Carbon $dateFrom = null, ?Carbon $dateTo = null, SearchSort $sort = SearchSort::SCORE, SearchVote $votes = SearchVote::HUNDRED, array $domains = [], array $users = [], array $tags = [], ?string $category = null, ?string $bucket = null)
 * @method static array getSearchLinks(string $query, ?Carbon $dateFrom = null, ?Carbon $dateTo = null, SearchSort $sort = SearchSort::SCORE, SearchVote $votes = SearchVote::HUNDRED, array $domains = [], array $users = [], array $tags = [], ?string $category = null, ?string $bucket = null, int $page = 1, int $limit = 25)
 * @method static array getSearchEntries(string $query, ?Carbon $dateFrom = null, ?Carbon $dateTo = null, SearchSort $sort = SearchSort::SCORE, SearchVote $votes = SearchVote::HUNDRED, array $domains = [], array $users = [], array $tags = [], ?string $category = null, ?string $bucket = null, int $page = 1, int $limit = 25)
 * @method static array getSearchUsers(string $query, SearchUsersSort $sort = SearchUsersSort::SCORE, array $users = [], int $page = 1)
 */
