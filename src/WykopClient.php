...
class WykopClient
{
    ...
    {
        return ApiClient::get(self::profilePath($username));
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/short');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/actions');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/entries/added');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/entries/commented');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/links/added');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/links/published');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/links/up');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/links/down');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/links/commented');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/observed/users/following');
    }
    ...
    {
        return ApiClient::get(self::profilePath($username) . '/observed/users/followers');
    }
}
